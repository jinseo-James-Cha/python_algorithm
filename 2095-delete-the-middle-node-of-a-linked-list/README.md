<h2><a href="https://leetcode.com/problems/delete-the-middle-node-of-a-linked-list/editorial/?envType=study-plan-v2&envId=leetcode-75">2216. Delete the Middle Node of a Linked List</a></h2><h3>Medium</h3><hr><p>You are given the <code>head</code> of a linked list. <strong>Delete</strong> the <strong>middle node</strong>, and return <em>the</em> <code>head</code> <em>of the modified linked list</em>.</p>
