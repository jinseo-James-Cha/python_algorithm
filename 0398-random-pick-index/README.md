<h2><a href="https://leetcode.com/problems/random-pick-index/?envType=problem-list-v2&envId=w3zbfufh">398. Random Pick Index</a></h2><h3>Medium</h3><hr><p>Given an integer array <code>nums</code> with possible <strong>duplicates</strong>, randomly output the index of a given <code>target</code> number. You can assume that the given target number must exist in the array.</p>
